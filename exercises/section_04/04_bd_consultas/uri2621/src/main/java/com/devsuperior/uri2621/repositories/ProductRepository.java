...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    List<ProductMinProjection> filterByAmount(Integer min, Integer max, String beginName);
    ...
    List<ProductMinDTO> filterByAmount2(Integer min, Integer max, String beginName);
